...
def randint(min_val, max_val):
    return min_val + urandom.getrandbits(3) % (max_val - min_val + 1)
...
twobigcactus=bytearray([	0xff, 0xff, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 
	0xfc, 0xf0, 0xf3, 0x3c, 0xc0, 0x33, 0x0c, 0xc0, 0x33, 0x0c, 0xc0, 0x33, 0x0c, 0xc0, 0x33, 0x0c, 
	0xc0, 0x33, 0x0c, 0xc0, 0x33, 0x0c, 0xc0, 0x33, 0x0c, 0xc0, 0x80, 0x60, 0x10, 0xc0, 0x70, 0x10, 
	0xf3, 0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xf3, 
	0xfc, 0xf0, 0xf3, 0xfc, 0xf0, 0xe3, 0xf8, 0xf0, 0xfd, 0xff, 0x70, 0xff, 0xff, 0xf0])

fbtwobigcactus=framebuf.FrameBuffer(twobigcactus, 20,26, framebuf.MONO_HLSB) 

twosmallcactus=bytearray([	0xe7, 0xe7, 0xe7, 0xe7, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x04, 0x04, 
	0x80, 0x80, 0xe1, 0xe1, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7])

fbtwosmallcactus=framebuf.FrameBuffer(twosmallcactus,16,16, framebuf.MONO_HLSB) 

twosmallonebig=bytearray([	0xff, 0xff, 0xff, 0xc0, 0xff, 0xf3, 0xff, 0xc0, 0xff, 0xf3, 0xff, 0xc0, 0xff, 0xf3, 0xff, 0xc0, 
	0xff, 0xf3, 0xff, 0xc0, 0xff, 0xf3, 0xff, 0xc0, 0xff, 0xf3, 0x3f, 0xc0, 0xff, 0x33, 0x3f, 0xc0, 
	0xe7, 0x33, 0x39, 0xc0, 0xe7, 0x33, 0x39, 0xc0, 0x24, 0x33, 0x09, 0x00, 0x24, 0x33, 0x09, 0x00, 
	0x24, 0x33, 0x09, 0x00, 0x24, 0x33, 0x09, 0x00, 0x24, 0x80, 0x49, 0x00, 0x04, 0xc0, 0x41, 0x00, 
	0x80, 0xf3, 0xe0, 0x00, 0xe1, 0xf3, 0xf8, 0x40, 0xe7, 0xf3, 0xf9, 0xc0, 0xe7, 0xf3, 0xf9, 0xc0, 
	0xe7, 0xf3, 0xf9, 0xc0, 0xe7, 0xf3, 0xf9, 0xc0, 0xe7, 0xf3, 0xf9, 0xc0, 0xe7, 0xe0, 0xf9, 0xc0])

fbtwosmallonebigcactus=framebuf.FrameBuffer(twosmallonebig,26,24, framebuf.MONO_HLSB) 

twosmalltwobig=bytearray([	0xff, 0xff, 0xff, 0xff, 0xf0, 0xff, 0xf3, 0xfc, 0xff, 0xf0, 0xff, 0xf3, 0xfc, 0xff, 0xf0, 0xff, 
	0xf3, 0xfc, 0xff, 0xf0, 0xff, 0xf3, 0xfc, 0xff, 0xf0, 0xff, 0xf3, 0xfc, 0xff, 0xf0, 0xff, 0xf3, 
	0x3c, 0xcf, 0xf0, 0xff, 0x33, 0x0c, 0xcf, 0xf0, 0xe7, 0x33, 0x0c, 0xce, 0x70, 0xe7, 0x33, 0x0c, 
	0xce, 0x70, 0x24, 0x33, 0x0c, 0xc2, 0x40, 0x24, 0x33, 0x0c, 0xc2, 0x40, 0x24, 0x33, 0x0c, 0xc2, 
	0x40, 0x24, 0x33, 0x0c, 0xc2, 0x40, 0x24, 0x80, 0x60, 0x12, 0x40, 0x04, 0xc0, 0x70, 0x10, 0x40, 
	0x80, 0xf3, 0xfc, 0xf8, 0x00, 0xe1, 0xf3, 0xfc, 0xfe, 0x10, 0xe7, 0xf3, 0xfc, 0xfe, 0x70, 0xe7, 
	0xf3, 0xfc, 0xfe, 0x70, 0xe7, 0xf3, 0xfc, 0xfe, 0x70, 0xe7, 0xf3, 0xfc, 0xfe, 0x70, 0xe7, 0xf3, 
	0xfc, 0xfe, 0x70, 0xe7, 0xe0, 0xf8, 0x3e, 0x70])

fbtwosmalltwobig=framebuf.FrameBuffer(twosmalltwobig,36,24, framebuf.MONO_HLSB) 
...
def nextobject () :
    ...
    if random_number==3 :
        return  20,26,fbtwobigcactus,40
    if random_number==4  :
        return  16,16,fbtwosmallcactus,47
    if random_number==5   :
        return  26,24,fbtwosmallonebigcactus,40
    if random_number==6 :
        return  36,24,fbtwosmalltwobig,40
score=0
while True:
    ...
    if not is_jumping and check_collision(dino_x, dino_y, dino_width, dino_height, cactus_x, cactus_y, cactus_width, cactus_height):
        ...
        while (True) :
            ...
            oled.text("Score :", 10, 10)
            oled.text(str(score), 20, 20)
            oled.text("Tap button start", 0, 30)
            oled.show()
            if(button.value() == 1) :
                score=0
                sleep(0.5)
